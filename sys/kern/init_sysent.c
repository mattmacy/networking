...
struct sysent sysent[] = {
	...
	{ AS(iflib_open_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, SYF_CAPENABLED, SY_THR_ABSENT },	/* 578 = iflib_open */
	{ AS(iflib_ctl_args), (sy_call_t *)lkmressys, AUE_NULL, NULL, 0, 0, SYF_CAPENABLED, SY_THR_ABSENT },	/* 579 = iflib_ctl */
};
