...
ztest_info_t ztest_info[] = {
...
#if 0
	ZI{ ztest_dmu_prealloc,			1,	&zopt_sometimes	},
#endif
	...
	ZI{ ztest_fault_inject,			1,	&zopt_incessant	},
	ZI{ ztest_ddt_repair,			1,	&zopt_sometimes	},
	ZI{ ztest_dmu_snapshot_hold,		1,	&zopt_sometimes	},
	ZI{ ztest_reguid,				1,	&zopt_rarely	},
	ZI{ ztest_spa_rename,			1,	&zopt_rarely	},
	ZI{ ztest_scrub,				1,	&zopt_often	},
	ZI{ ztest_spa_upgrade,			1,	&zopt_rarely	},
	ZI{ ztest_dsl_dataset_promote_busy,	1,	&zopt_rarely	},
	ZI{ ztest_vdev_attach_detach,		1,	&zopt_incessant	},
	ZI{ ztest_vdev_LUN_growth,		1,	&zopt_rarely	},
	ZI{ ztest_vdev_add_remove,		1,
	    &ztest_opts.zo_vdevtime				},
	ZI{ ztest_vdev_aux_add_remove,		1,
	    &ztest_opts.zo_vdevtime				},
	ZI{ ztest_device_removal,			1,	&zopt_sometimes	},
	ZI{ ztest_remap_blocks,			1,	&zopt_sometimes },
	ZI{ ztest_spa_checkpoint_create_discard,	1,	&zopt_rarely	},
	ZI{ ztest_initialize,			1,	&zopt_sometimes }
};
